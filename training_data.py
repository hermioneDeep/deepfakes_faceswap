...
class TrainingDataGenerator():
    ...
    """
    def __init__(model_input_size, model_output_shapes, coverage_ratio, augment_color = False, no_flip = True):
        self._config = config
    ...
    def minibatch_ab(images, batchsize, side,
...
#            batch[..., :3] = self._processing.color_adjust(batch[..., :3]) //TODO
